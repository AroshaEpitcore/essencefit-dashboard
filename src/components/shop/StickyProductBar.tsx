      ...
      {visible && (
        ...
        >
          <div className="max-w-[1920px] mx-auto px-4 sm:px-6 py-2.5 flex items-center gap-3 sm:gap-4">
            ...
            <button
              onClick={onAddToCart}
              className="shrink-0 bg-gray-900 text-white px-4 sm:px-6 py-2.5 text-sm font-semibold rounded-sm flex items-center gap-2 hover:bg-gray-800 transition-colors"
            >
