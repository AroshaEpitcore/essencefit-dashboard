              ...
              {data.topColors.length === 0 ? <NoData /> : (
                <ResponsiveContainer width="100%" height={280}>
                  <PieChart>
                    ...
                    <Tooltip formatter={(v: any) => [`${v} pcs`, "Sold"]} />
                  </PieChart>
                </ResponsiveContainer>
              )}
            </ChartCard>
              ...
              {data.topCategories.length === 0 ? <NoData /> : (
                <ResponsiveContainer width="100%" height={280}>
                  <PieChart>
                    ...
                    <Tooltip formatter={(v: any) => [`Rs ${Number(v).toFixed(2)}`, "Revenue"]} />
                  </PieChart>
                </ResponsiveContainer>
              )}
            </ChartCard>
              ...
              {data.monthlySales.length === 0 ? <NoData /> : (
                <ResponsiveContainer width="100%" height={320}>
                  <LineChart data={data.monthlySales}>
                    ...
                    <YAxis />
                    <Tooltip formatter={(v: any) => [`Rs ${Number(v).toFixed(2)}`]} />
                    <Legend />
              ...
              {data.dailySales.length === 0 ? <NoData /> : (
                <ResponsiveContainer width="100%" height={320}>
                  <AreaChart data={data.dailySales}>
                    ...
                    <YAxis />
                    <Tooltip formatter={(v: any) => [`Rs ${Number(v).toFixed(2)}`, "Sales"]} />
